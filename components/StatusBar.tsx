  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <button className="flex items-center gap-1 hover:bg-[var(--accent-hover)] px-1 py-0.5 rounded">
          <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
            <path d="M14 1H2C0.9 1 0 1.9 0 3V13C0 14.1 0.9 15 2 15H14C15.1 15 16 14.1 16 13V3C16 1.9 15.1 1 14 1ZM14 13H2V3H14V13ZM7 12H9V7H7V12ZM7 5H9V3H7V5Z"/>
          </svg>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="hover:bg-[var(--accent-hover)] px-1 py-0.5 rounded cursor-pointer">Spaces: 2</span>
        ...
        <span className="hover:bg-[var(--accent-hover)] px-1 py-0.5 rounded cursor-pointer">TypeScript</span>
        <button className="flex items-center gap-1 hover:bg-[var(--accent-hover)] px-1 py-0.5 rounded">
          <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
